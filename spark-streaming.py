...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.3")  # Spark-Kafka integration
             .config("spark.jars",
                     "/home/punam24/RealtimeVotingSystem/postgresql-42.7.4.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/punam24/RealtimeVotingSystem/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/punam24/RealtimeVotingSystem/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
